...
const AuthStack: React.FC = () => (
  <Stack.Navigator<AuthStackParamList> screenOptions={{ headerShown: false }}>
...
const ExpenseStack: React.FC = () => (
  <Stack.Navigator<ExpenseStackParamList>>
...
const IncomeStack: React.FC = () => (
  <Stack.Navigator<IncomeStackParamList>>
...
const BillsStack: React.FC = () => (
  <Stack.Navigator<BillsStackParamList>>
